...
defaultHeaders["User-Agent"] = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.122 Safari/537.36";
let allProxyAgents = [];
...
function (useCaptcha) {
	...
	var t = Buffer.alloc(5);
        ...
        break;
			...
			inits = Buffer.alloc(5);
			inits.writeUInt8(255, 0);
			inits.writeUInt32LE(154669603, 1, 0);
			this.send(inits);
		     break;
       ...
       case 'cellcraft.io':
		...
		case 'ogar.be':
			...
			case 'bubble.am':
			   ...
			   //this.send(Buffer.from([0, 112, 0, 108, 0, 115, 0, 32, 0, 119, 0, 111, 0, 114, 0, 107, 0, 32, 0, 97, 0, 103, 0, 97, 0, 105, 0, 106, 0, 110, 0]));
			   this.send(Buffer.from([230]));
			   this.send(Buffer.from([19]));
			   break;
